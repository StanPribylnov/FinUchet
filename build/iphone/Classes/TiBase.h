...
// in simulator we redefine to format for _______ Developer console
...
{\
	NSString * exceptionName = [@"org._______." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org._______";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UI_______NativeItemNone = -1, 
	UI_______NativeItemSpinner = -2,
	UI_______NativeItemProgressBar = -3,
	
	UI_______NativeItemSlider = -4,
	UI_______NativeItemSwitch = -5,
	UI_______NativeItemMultiButton = -6,
	UI_______NativeItemSegmented = -7,
	
	UI_______NativeItemTextView = -8,
	UI_______NativeItemTextField = -9,
	UI_______NativeItemSearchBar = -10,
	
	UI_______NativeItemPicker = -11,
	UI_______NativeItemDatePicker = -12,
	
	UI_______NativeItemInfoLight = -13,
	UI_______NativeItemInfoDark = -14,
	
	UI_______NativeItemDisclosure = -15,
	
	UI_______NativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all _______ instances of
