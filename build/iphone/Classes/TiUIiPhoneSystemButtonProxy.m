...
MAKE_SYSTEM_PROP(ACTIVITY,UI_______NativeItemSpinner);
MAKE_SYSTEM_PROP(SPINNER,UI_______NativeItemSpinner);
MAKE_SYSTEM_PROP(INFO_LIGHT,UI_______NativeItemInfoLight);
MAKE_SYSTEM_PROP(INFO_DARK,UI_______NativeItemInfoDark);
MAKE_SYSTEM_PROP(DISCLOSURE,UI_______NativeItemDisclosure);
MAKE_SYSTEM_PROP(CONTACT_ADD,UI_______NativeItemContactAdd);
