...
//@interface _______Object : NSObject
//@end

@interface _______Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[_______Object class]])
		{
			for (NSString *key in [[(_______Object*)o modules] allKeys])
			{
