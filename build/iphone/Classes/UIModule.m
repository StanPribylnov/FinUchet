...
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED_REMOVED(BLEND_MODE_NORMAL,kCGBlendModeNormal, @"UI.BLEND_MODE_NORMAL", @"1.8.0", @"6.0.0", @"UI.iOS.BLEND_MODE_NORMAL");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED_REMOVED(BLEND_MODE_MULTIPLY,kCGBlendModeMultiply, @"UI.BLEND_MODE_MULTIPLY", @"1.8.0", @"6.0.0", @"UI.iOS.BLEND_MODE_MULTIPLY");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED_REMOVED(BLEND_MODE_SCREEN,kCGBlendModeScreen, @"UI.BLEND_MODE_SCREEN", @"1.8.0", @"6.0.0", @"UI.iOS.BLEND_MODE_SCREEN");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED_REMOVED(BLEND_MODE_OVERLAY,kCGBlendModeOverlay, @"UI.BLEND_MODE_OVERLAY", @"1.8.0", @"6.0.0", @"UI.iOS.BLEND_MODE_OVERLAY");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED_REMOVED(BLEND_MODE_DARKEN,kCGBlendModeDarken, @"UI.BLEND_MODE_DARKEN", @"1.8.0", @"6.0.0", @"UI.iOS.BLEND_MODE_DARKEN");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED_REMOVED(BLEND_MODE_LIGHTEN,kCGBlendModeLighten, @"UI.BLEND_MODE_LIGHTEN", @"1.8.0", @"6.0.0", @"UI.iOS.BLEND_MODE_LIGHTEN");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED_REMOVED(BLEND_MODE_COLOR_DODGE,kCGBlendModeColorDodge, @"UI.BLEND_MODE_COLOR_DODGE", @"1.8.0", @"6.0.0", @"UI.iOS.BLEND_MODE_COLOR_DODGE");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED_REMOVED(BLEND_MODE_COLOR_BURN,kCGBlendModeColorBurn, @"UI.BLEND_MODE_COLOR_BURN", @"1.8.0", @"6.0.0", @"UI.iOS.BLEND_MODE_COLOR_BURN");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED_REMOVED(BLEND_MODE_SOFT_LIGHT,kCGBlendModeSoftLight, @"UI.BLEND_MODE_SOFT_LIGHT", @"1.8.0", @"6.0.0", @"UI.iOS.BLEND_MODE_SOFT_LIGHT");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED_REMOVED(BLEND_MODE_HARD_LIGHT,kCGBlendModeHardLight, @"UI.BLEND_MODE_HARD_LIGHT", @"1.8.0", @"6.0.0", @"UI.iOS.BLEND_MODE_HARD_LIGHT");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED_REMOVED(BLEND_MODE_DIFFERENCE,kCGBlendModeDifference, @"UI.BLEND_MODE_DIFFERENCE", @"1.8.0", @"6.0.0", @"UI.iOS.BLEND_MODE_DIFFERENCE");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED_REMOVED(BLEND_MODE_EXCLUSION,kCGBlendModeExclusion, @"UI.BLEND_MODE_NORMAL", @"1.8.0", @"6.0.0", @"UI.iOS.BLEND_MODE_NORMAL");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED_REMOVED(BLEND_MODE_HUE,kCGBlendModeHue, @"UI.BLEND_MODE_HUE", @"1.8.0", @"6.0.0", @"UI.iOS.BLEND_MODE_HUE");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED_REMOVED(BLEND_MODE_SATURATION,kCGBlendModeSaturation, @"UI.BLEND_MODE_SATURATION", @"1.8.0", @"6.0.0", @"UI.iOS.BLEND_MODE_SATURATION");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED_REMOVED(BLEND_MODE_COLOR,kCGBlendModeColor, @"UI.BLEND_MODE_COLOR", @"1.8.0", @"6.0.0", @"UI.iOS.BLEND_MODE_COLOR");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED_REMOVED(BLEND_MODE_LUMINOSITY,kCGBlendModeLuminosity, @"UI.BLEND_MODE_LUMINOSITY", @"1.8.0", @"6.0.0", @"UI.iOS.BLEND_MODE_LUMINOSITY");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED_REMOVED(BLEND_MODE_CLEAR,kCGBlendModeClear, @"UI.BLEND_MODE_CLEAR", @"1.8.0", @"6.0.0", @"UI.iOS.BLEND_MODE_CLEAR");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED_REMOVED(BLEND_MODE_COPY,kCGBlendModeCopy, @"UI.BLEND_MODE_COPY", @"1.8.0", @"6.0.0", @"UI.iOS.BLEND_MODE_COPY");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED_REMOVED(BLEND_MODE_SOURCE_IN,kCGBlendModeSourceIn, @"UI.BLEND_MODE_SOURCE_IN", @"1.8.0", @"6.0.0", @"UI.iOS.BLEND_MODE_SOURCE_IN");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED_REMOVED(BLEND_MODE_SOURCE_OUT,kCGBlendModeSourceOut, @"UI.BLEND_MODE_SOURCE_OUT", @"1.8.0", @"6.0.0", @"UI.iOS.BLEND_MODE_SOURCE_OUT");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED_REMOVED(BLEND_MODE_SOURCE_ATOP,kCGBlendModeSourceAtop, @"UI.BLEND_MODE_SOURCE_ATOP", @"1.8.0", @"6.0.0", @"UI.iOS.BLEND_MODE_SOURCE_ATOP");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED_REMOVED(BLEND_MODE_DESTINATION_OVER,kCGBlendModeDestinationOver, @"UI.BLEND_MODE_DESTINATION_OVER", @"1.8.0", @"6.0.0", @"UI.iOS.BLEND_MODE_DESTINATION_OVER");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED_REMOVED(BLEND_MODE_DESTINATION_IN,kCGBlendModeDestinationIn, @"UI.BLEND_MODE_DESTINATION_IN", @"1.8.0", @"6.0.0", @"UI.iOS.BLEND_MODE_DESTINATION_IN");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED_REMOVED(BLEND_MODE_DESTINATION_OUT,kCGBlendModeDestinationOut, @"UI.BLEND_MODE_DESTINATION_OUT", @"1.8.0", @"6.0.0", @"UI.iOS.BLEND_MODE_DESTINATION_OUT");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED_REMOVED(BLEND_MODE_DESTINATION_ATOP,kCGBlendModeDestinationAtop, @"UI.BLEND_MODE_DESTINATION_ATOP", @"1.8.0", @"6.0.0", @"UI.iOS.BLEND_MODE_DESTINATION_ATOP");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED_REMOVED(BLEND_MODE_XOR,kCGBlendModeXOR, @"UI.BLEND_MODE_XOR", @"1.8.0", @"6.0.0", @"UI.iOS.BLEND_MODE_XOR");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED_REMOVED(BLEND_MODE_PLUS_DARKER,kCGBlendModePlusDarker, @"UI.BLEND_MODE_PLUS_DARKER", @"1.8.0", @"6.0.0", @"UI.iOS.BLEND_MODE_PLUS_DARKER");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED_REMOVED(BLEND_MODE_PLUS_LIGHTER,kCGBlendModePlusLighter, @"UI.BLEND_MODE_PLUS_LIGHTER", @"1.8.0", @"6.0.0", @"UI.iOS.BLEND_MODE_PLUS_LIGHTER");
